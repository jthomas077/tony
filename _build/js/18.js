(window["AnthonysContracting"] = window["AnthonysContracting"] || []).push([[18],{
...
var QuoteBar = function (_Module) {
    _inherits(QuoteBar, _Module);

    function QuoteBar(el, opts) {
        _classCallCheck(this, QuoteBar);

        return _possibleConstructorReturn(this, (QuoteBar.__proto__ || Object.getPrototypeOf(QuoteBar)).call(this, el, opts));
    }
