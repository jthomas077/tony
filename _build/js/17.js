(window["AnthonysContracting"] = window["AnthonysContracting"] || []).push([[17],{
...
var Ideas = function (_Module) {
    _inherits(Ideas, _Module);

    function Ideas(el, opts) {
        _classCallCheck(this, Ideas);

        return _possibleConstructorReturn(this, (Ideas.__proto__ || Object.getPrototypeOf(Ideas)).call(this, el, opts));
    }
