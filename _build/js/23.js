(window["AnthonysContracting"] = window["AnthonysContracting"] || []).push([[23],{
...
var WorkWithUs = function (_Module) {
    _inherits(WorkWithUs, _Module);

    function WorkWithUs(el, opts) {
        _classCallCheck(this, WorkWithUs);

        return _possibleConstructorReturn(this, (WorkWithUs.__proto__ || Object.getPrototypeOf(WorkWithUs)).call(this, el, opts));
    }
